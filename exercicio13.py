...
<body style="font-family: 'Arial', sans-serif; background-color: #f8f8f8; margin: 0; padding: 0;">
    ...
    <header style="text-align: center; background-color: #3498db; color: #fff; padding: 20px;">
        ...
        <h1 style="margin: 0;">Raphael Augusto Sant'Ana</h1>
    ...
    <section style="margin: 20px; text-align: center;">
        ...
        <img src="https://avatars.githubusercontent.com/u/102390386?v=4" alt="Sua Foto" style="border-radius: 50%; margin-bottom: 20px;">
    ...
    <footer style="text-align: center; margin-top: 20px;">
        ...
        <a href="https://www.linkedin.com/in/raphael-sant-ana/" target="_blank" style="margin: 0 10px; color: #3498db; text-decoration: none;">LinkedIn</a>
